(function() {
    ...
    style.textContent = `
        ...
        :root {
            --eclipse-bg: #0a0a0f;
            --eclipse-surface: #11111a;
            --eclipse-border: #222233;
            --eclipse-primary: #ff3366;
            --eclipse-primary-light: #ff6699;
            --eclipse-accent: #00ffcc;
            --eclipse-danger: #ff3333;
            --eclipse-text: #ffffff;
            --eclipse-text-muted: #a0a0c0;
            --eclipse-success: #00ff88;
            --eclipse-error: #ff3333;
        }
        ...
        @keyframes pulse {
            ...
            70% { transform: scale(1.02); box-shadow: 0 0 0 12px rgba(255, 51, 102, 0); }
        ...
        @keyframes neonGlow {
            0%, 100% { text-shadow: 0 0 5px #ff3366, 0 0 10px #ff3366, 0 0 15px #ff3366; }
            50% { text-shadow: 0 0 10px #ff3366, 0 0 20px #ff3366, 0 0 30px #ff3366; }
        }
        ...
        .eclipse-splash {
            ...
            width: 100vw;
            height: 100vh;
            background: linear-gradient(135deg, #000000, #0a0a0f, #11111a);
            display: flex;
        ...
        .eclipse-splash::before {
            ...
            height: 100%;
            background: 
                radial-gradient(circle at 20% 30%, rgba(255, 51, 102, 0.15), transparent 30%),
                radial-gradient(circle at 80% 70%, rgba(0, 255, 204, 0.1), transparent 30%),
                linear-gradient(to bottom, transparent 95%, rgba(255, 51, 102, 0.05));
        ...
        .eclipse-splash::after {
            ...
            height: 100%;
            background-image: 
                radial-gradient(1px 1px at 20px 20px, #ff3366 1px, transparent 1px),
                radial-gradient(1px 1px at 40px 40px, #00ffcc 1px, transparent 1px),
                radial-gradient(1px 1px at 60px 60px, #3366ff 1px, transparent 1px);
        ...
        .eclipse-splash-title {
            ...
            font-weight: 900;
            margin-bottom: 12px;
            background: linear-gradient(to right, #ff3366, #ff0066, #ff66aa);
        ...
        .eclipse-splash-glitch {
            ...
            font-weight: 900;
            color: transparent;
            -webkit-text-stroke: 1px rgba(255, 51, 102, 0.3);
            z-index: 1;
        ...
        .eclipse-panel {
            ...
            width: 380px;
            max-height: 75vh;
            background: linear-gradient(145deg, #0a0a0f, #11111a);
            border-radius: 20px;
        ...
        .eclipse-title {
            font-weight: 800;
            font-size: 24px;
            background: linear-gradient(to right, #ff3366, #ff6699, #00ffcc);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            text-fill-color: transparent;
        ...
        .eclipse-tab-content::-webkit-scrollbar-thumb {
            background: linear-gradient(to bottom, var(--eclipse-primary), var(--eclipse-accent));
            border-radius: 4px;
        }
        ...
        .eclipse-speed-value {
            ...
            text-shadow: 0 0 10px var(--eclipse-primary);
        }
    ...
    (async function initializeUI() {
        ...
        splash.innerHTML = `
            <div class="eclipse-splash-glitch">DESTROYER KHAN</div>
            <div class="eclipse-splash-content">
                <div class="eclipse-splash-title">DESTROYER KHAN</div>
                <div class="eclipse-splash-subtitle">Sistema de Automação Total</div>
                ...
                <div class="eclipse-splash-status">
                    ...
                    <div>Inicializando Sistema Destruidor</div>
                </div>
            </div>
        `;
            ...
            <div id="eclipse-tab-about" class="eclipse-tab-content">
                <div class="eclipse-about-content">
                    ...
                    <div class="eclipse-credits">
                        ...
                        DESTROYER KHAN • Sistema de Automação Total
                    </div>
                </div>
            </div>
